<div class="form-group {{$width}}">
    ...
    <div class="input-group mb-3">
        ...
        <button class="btn btn-outline rounded-left dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{$options[0]['title']}}</button>
